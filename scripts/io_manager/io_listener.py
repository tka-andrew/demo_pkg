...
class IoListener():
    def __init__(self):
        ...
        self.input_subs = [rospy.Subscriber('io/input/port%d' % (i), UInt16, self.input_callback, i, queue_size=10) for i in range(1,9)]
        self.output_subs = [rospy.Subscriber('io/output/port%d' % (i), UInt16, self.output_callback, i, queue_size=10) for i in range(1,9)]
